...
func (cfg *apiConfig) handlerUploadThumbnail(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		respondWithError(w, http.StatusBadRequest, "Couldn't get the form file", err)
		return
	}
	defer file.Close()
	...
	if err != nil {
		respondWithError(w, http.StatusInternalServerError, "Couldn't get the video from the db", err)
		return
	}
